...
from models.CapsGI import CapsGI
...
def main():
    ...
    parser.add_argument('--num_cluster', type=int, default=31,
    ...
    model_pretrain = CapsGI(args.num_layers, args.num_mlp_layers, input_dim, args.hidden_dim, args.neighbor_pooling_type, device).to(device)
